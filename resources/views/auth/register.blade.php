            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('inscription') }}">
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-md-4 col-form-label text-md-right">{{ __('Pseudo') }}</label>

                            <div class="col-md-6">
                                <input id="email" type="text" class="form-control @error('email') is-invalid @enderror" name="pseudo" value="{{ old('email') }}" required autocomplete="email">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="text" class="form-control @error('email') is-invalid @enderror" name="genre" value="{{ old('email') }}" required autocomplete="email">
